      ...
      <div class="section">
        <div class="section-body">
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
              <input name="customer_link" type="text" class="form-control" placeholder="กรอกลิ้งค์ติดต่อ เช่น ลิ้งค์เฟสบุ๊ค">
            </div>
          </div>
          <div class="form-group">
            <div class="col-md-3">
            ...
            <div class="form-footer">
              <div class="form-group">
                <div class="col-md-9 col-md-offset-3">
                  ...
                  <a href="<?php echo SITE_URL('Admin/customer_list')?>"><button type="button" class="btn btn-default">ยกเลิก</button></a>
                </div>
              </div>
            </div>
            <?php echo form_close()?>
