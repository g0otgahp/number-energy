...
<div class="col-xs-12">
  <div class="card">
    <div class="card-header"> ประเภทของเบอร์ </div>
    <div class="card-body no-padding">
      <table class="datatable table table-hover primary" cellspacing="0" width="100%">
        ...
        <tbody>
          ...
          <tr style="cursor: pointer;" onclick="document.location = '<?php echo site_url('Admin/product_type_update')?>/<?php echo $row['product_type_id']?>';">
            <td align="center"><?php echo $i ?></td>
            <td align="left"><?php echo $row['product_type_name']?></td>
          </tr>
          <?php $i++ ?>
          <?php } ?>
        </tbody>
...
<div class="btn-floating" id="help-actions">
  ...
  <a href="<?php echo site_url('Admin/product_type_insert')?>">
